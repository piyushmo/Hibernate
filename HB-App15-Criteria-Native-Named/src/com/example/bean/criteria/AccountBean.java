package com.example.bean.criteria;
...
@NamedQueries({
	...
	@NamedQuery(name = "AccountBean.find.all", query="FROM AccountBean"),
	@NamedQuery(name = "AccountBean.find.allID",  query="FROM AccountBean a WHERE a.accountId=:accountId" )
})
